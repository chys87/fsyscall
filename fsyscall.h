...
def_fsys(real_faccessat,faccessat,int,3,int,const char *,int)
#define fsys_faccessat(fd,path,mode,flags) ((flags) == 0 ? fsys_real_faccessat(fd, path, mode) : (faccessat)(fd, path, mode, flags))
